...
def process_file(folder, output):
    ...
    for split in ['test']:
        ...
        for item in tqdm(data):
            ...
            e_end = orig_to_tok_index[e_end_word] if e_end_word < len(orig_to_tok_index) else len(orig_to_tok_index)
...
if __name__ == '__main__':
    process_file("/private/home/xwhan/dataset/FIGER",
                 "/private/home/xwhan/dataset/FIGER/processed-splits")
