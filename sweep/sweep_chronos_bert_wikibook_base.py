...
def get_grid(args):
    return [
        ...
        hyperparam("--min-loss-scale", 0.0001),
        ...
        hyperparam("--arch", "hf_wikibook_base", save_dir_key=lambda val: val),
        ...
        hyperparam("--lr", 0.00025),
        #hyperparam("--max-lr", 1.3e-4, save_dir_key=lambda val: f"lr{val}"),
        #hyperparam("--max-lr", 2e-4, save_dir_key=lambda val: f"lr{val}"),
        hyperparam("--max-update", 2400000),
        hyperparam("--min-lr", -1),
        hyperparam("--total-num-update", 2400000),
        hyperparam("--clip-norm", 1, save_dir_key=lambda val: f"clip{val}"),
