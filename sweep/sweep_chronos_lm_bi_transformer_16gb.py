...
def get_grid(args):
    return [
        ...
        hyperparam("--add-bos-token", save_dir_key=lambda val: f"addbos"),
        hyperparam("--self-target", True, binary_flag=True, save_dir_key=lambda val: f"self"),
        ...
        hyperparam("--lr", 1e-4),
        hyperparam("--max-lr", 3.33e-4, save_dir_key=lambda val: f"lr{val}"),
        hyperparam("--max-update", 100000),
